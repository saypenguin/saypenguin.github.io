...
<div class="container">
    ...
    <section id="intro">
        ...
        <p>このサイトでは、知っているようで知らないペンギンの生態を、科学的な視点と親しみやすい解説で紐解いていきます。</p>
    </section>
...
もし本格的な独自ドメイン（penguin-world.comなど）を取りたい場合は、レンタルサーバー（エックスサーバーやロリポップなど）の契約が必要になりますが、まずは無料サービスで試してみるのが良いと思います！
